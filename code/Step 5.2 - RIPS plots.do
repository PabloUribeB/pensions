    ...
    foreach cohort in M50 F55{
        ...
        foreach runvar in std_weeks std_days {
            ...
            foreach model in rdrobust rdhonest {
                ...
                1 "95% confidence interval")) xline(59.5, lcolor(gs7))              ///
                ...
                graph export "${graphs}/latest/RIPS/age\\`variable'_`cohort'_`runvar'_`model'.png", replace
...
foreach cohort in M50 F55 {
    ...
    foreach runvar in std_days std_weeks {
        ...
        * Extensive margin
        ...
        graph export "${graphs}/latest/RIPS/DiffD_`cohort'_`runvar'_ext.png", replace
        ...
        * Intensive margin
        ...
        graph export "${graphs}/latest/RIPS/DiffD_`cohort'_`runvar'_int.png", replace
